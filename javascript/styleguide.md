Styleguide
===
Based on [Dockyards' styleguide](https://github.com/DockYard/styleguides/blob/master/engineering/javascript.md)
...
# Linter
We use [ESLint](https://eslint.org/) as our linter inside our projects. In the case of our Ember projects we also use the
